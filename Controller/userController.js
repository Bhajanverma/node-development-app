...
const getAllUsers = async (req, res) => {
  ...
  // Data filter with lodash / for checking only

  let filterDataWithLodash = _.filter(userData,function(item) {
    return item.isAdmin
  })
  ...
  let responseData = {
    ...
    status: 200,
    data: filterDataWithLodash,
  }
  res.send(responseData);


  // res.send(filterDataWithLodash)
};
